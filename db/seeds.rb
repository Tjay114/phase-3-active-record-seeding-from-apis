...
spells.each do |spell|
    #make a request to the database to the endpoint for the individual spell:
    ...
    Spell.create(
        ...
        description: spell_hash["desc"][0] #spell_hash["desc"] returns an array, so we need to access the first index to just a string of the description
    )
end
